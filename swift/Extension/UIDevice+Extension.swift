...
extension UIDevice {
    ...
    static let statusBarHeight = { () -> CGFloat in
        if isPhoneX {
            ...
            if ((UIDevice.getPhoneModel() as String).contains("iPhone 14") || (UIDevice.getPhoneModel() as String).contains("iPhone 13") || (UIDevice.getPhoneModel() as String).contains("iPhone 12")){
                return 47
            }
            else if ((UIDevice.getPhoneModel() as String).contains("iPhone 11"))
            {
                return 48
            }
            else if ((UIDevice.getPhoneModel() as String).contains("iPhone X"))
            {
                return 44
            }
...
//    }
//    
//    class func getMccMnc() -> String? {
//        let carrier = CTCarrier()
//        guard let mcc = carrier.mobileCountryCode else { return "" }
//        guard let mnc = carrier.mobileNetworkCode else { return "" }
//        guard let iso = carrier.isoCountryCode else { return "" }
//
//        return String(format: "%@-%@-%@", mcc,mnc,iso)
//    }
}
