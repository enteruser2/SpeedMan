...
#pragma mark -  * * * * * * * * * * * * * * 字体 * * * * * * * * * * * * * *
#define kPFSCMedium @"PingFangSC-Medium"
#define kPFSCRegular @"PingFangSC-Regular"
#define kPFSCSemibold @"PingFangSC-Semibold"


//#define KDINMedium(value) [UIFont fontWithName:@"DIN-Medium" size:value*ScreenScale]
//#define KDINRegular(value) [UIFont fontWithName:@"DIN-Regular" size:value*ScreenScale]
//#define KDINBold(value) [UIFont fontWithName:@"DIN-Bold" size:value*ScreenScale]
 ...
 *  默认页面背景色
 */
#define DefaultBackGroundColor UIColorFromRGBValue(0X363bb9)
/**
 *  默认白色
 */
 ...
 *  主题颜色
 */
#define ThemeColor UIColorFromRGBValue(0X363BB9)
/**
 ...
 *  默认字体颜色(非点击状态)
 */
#define kNormalFontColor UIColorFromRGBValue(0X4E54DE)
 ...
 *  14号字体
 */
#define FourteenFontSize [UIFont fontWithName:kPFSCMedium size:14*ScreenScale]
/**
 *  15号字体
 */
 ...
 *  18号字体
 */
#define EighteenFontSize [UIFont fontWithName:kPFSCRegular size:18*ScreenScale]
/**
 *  20号字体
 */
